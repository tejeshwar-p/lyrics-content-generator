...
public class Testing {
    public static void main(String[] args) {
        ...
        System.out.println(getTranslitEnglishTitleString("ఏ తెగులూ నీ గుడారమున్ సమీపించదయ్యా"));
    }
    ...
    private static String getTranslitEnglishTitleString(String teluguTitleString) {
        ...
        Transliterator customTransliterator = Transliterator.createFromRules("customTeluguToEnglish", customRules, Transliterator.FORWARD);
        String englishTransliteration = customTransliterator.transliterate(teluguTitleString);
        /*Transliterator teluguToEnglish = Transliterator.getInstance("Telugu-Latin; Any-Latin/UNGEGN");
